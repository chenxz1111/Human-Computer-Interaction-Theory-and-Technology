...
/// </summary>
public abstract class GestureWidget3Phase : Sensor
{
    ...
    public GestureWidget3Phase(Handedness handedness = Handedness.Right)
    {
    ...
    public abstract bool GestureCondition3();
